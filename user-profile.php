...
?>
                                <h4 class="form--title"><i class="fa fa-user-edit color-main"></i>&nbsp;Personal Details</h4>
                            ...
                            <input type="submit" value="Save Edits" name="Submit" class="btn btn--primary text-center pb-50">
