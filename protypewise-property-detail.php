...
$query=mysqli_query($con,"SELECT tblproperty.*,tblcountry.CountryName,tblstate.StateName from tblproperty join tblcountry on tblcountry.ID=tblproperty.Country join tblstate on tblstate.ID=tblproperty.State WHERE Type='$protypeid'");
    ...
    <div class="col-xs-12 col-sm-6 col-md-4" style="padding-right: 10px; padding-left: 10px;">                           
            <div class="property-item" width="100%">
                ...
                <div class="property--info">
                    ...
                    <i class="fa fa fa-clock-o" aria-hidden="true"  style="margin-left: 12px;"></i>
                        <?php 
